...
seo_html: "<title>diff - DBWarden Documentation</title>\n<meta name=\"description\"\
  ...
  >\n<meta name=\"twitter:title\" content=\"diff - DBWarden Documentation\">\n<meta\
  \ name=\"twitter:description\" content=\"Show structural differences between SQLAlchemy\
  \ models and a live database. Read-only: no files are written.\">\n<meta name=\"\
  ...
  >\n[\n  {\n    \"@context\": \"https://schema.org\",\n    \"@type\": \"WebPage\"\
  ,\n    \"name\": \"diff - DBWarden Documentation\",\n    \"url\": \"https://dbwarden.emiliano-go.com/commands/diff\"\
  ,\n    \"description\": \"Show structural differences between SQLAlchemy models\
  \ and a live database. Read-only: no files are written.\",\n    \"image\": \"https://dbwarden.emiliano-go.com/assets/images/og-image.png\"\
  ,\n    \"publisher\": {\n      \"@type\": \"Organization\",\n      \"name\": \"\
