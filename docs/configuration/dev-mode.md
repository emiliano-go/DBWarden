...
seo_html: "<title>Dev Mode - DBWarden Documentation</title>\n<meta name=\"description\"\
  ...
  >\n<meta name=\"twitter:title\" content=\"Dev Mode - DBWarden Documentation\">\n\
  <meta name=\"twitter:description\" content=\"Use SQLite for local development and\
  \ PostgreSQL in production with the same codebase.\">\n<meta name=\"twitter:image\"\
