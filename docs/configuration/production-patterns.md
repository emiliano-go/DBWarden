...
seo:
  ...
  canonical: https://emiliano-go.github.io/DBWarden/configuration/production-patterns/
  robots: index,follow
  og:
    type: website
    title: Production Patterns - DBWarden Documentation
    description: Real-world configuration patterns for production deployments.
    url: https://emiliano-go.github.io/DBWarden/configuration/production-patterns/
