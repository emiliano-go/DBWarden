...
seo:
  ...
  description: 10. AutoGenerated Pydantic Schemas What You'll Learn How @autoschema
    generates Pydantic schemas from model annotations How public = False controls
    field visibility How CreateSchema, UpdateSchema, and...
