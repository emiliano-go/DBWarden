---
seo:
  title: Config Keys - DBWarden Documentation
  canonical: https://dbwarden.emiliano-go.com/databases/postgresql/config-keys
  robots: index,follow
  og:
    type: website
    title: Config Keys - DBWarden Documentation
    description: PostgreSQL features are configured through keys in your databaseconfig...
      call. These keys live alongside the connection URL and model paths.
    url: https://dbwarden.emiliano-go.com/databases/postgresql/config-keys
  ...
  - '@context': https://schema.org
    '@type': WebPage
    name: Config Keys - DBWarden Documentation
    url: https://dbwarden.emiliano-go.com/databases/postgresql/config-keys
    description: PostgreSQL features are configured through keys in your databaseconfig...
      call. These keys live alongside the connection URL and model paths.
    image: https://dbwarden.emiliano-go.com/assets/images/og-image.png
  ...
  - '@context': https://schema.org
    ...
    - '@type': ListItem
      position: 3
      name: Config Keys
      item: https://dbwarden.emiliano-go.com/databases/postgresql/config-keys
seo_html: "<title>Config Keys - DBWarden Documentation</title>\n<meta name=\"description\"\
  \ content=\"PostgreSQL features are configured through keys in your databaseconfig...\
  \ call. These keys live alongside the connection URL and model paths.\">\n<link\
  \ rel=\"canonical\" href=\"https://dbwarden.emiliano-go.com/databases/postgresql/config-keys\"\
  >\n<meta name=\"robots\" content=\"index,follow\">\n<meta property=\"og:type\" content=\"\
  website\">\n<meta property=\"og:title\" content=\"Config Keys - DBWarden Documentation\"\
  >\n<meta property=\"og:description\" content=\"PostgreSQL features are configured\
  \ through keys in your databaseconfig... call. These keys live alongside the connection\
  \ URL and model paths.\">\n<meta property=\"og:url\" content=\"https://dbwarden.emiliano-go.com/databases/postgresql/config-keys\"\
  ...
  >\n<meta name=\"twitter:title\" content=\"Config Keys - DBWarden Documentation\"\
  >\n<meta name=\"twitter:description\" content=\"PostgreSQL features are configured\
  \ through keys in your databaseconfig... call. These keys live alongside the connection\
  ...
  >\n[\n  {\n    \"@context\": \"https://schema.org\",\n    \"@type\": \"WebPage\"\
  ,\n    \"name\": \"Config Keys - DBWarden Documentation\",\n    \"url\": \"https://dbwarden.emiliano-go.com/databases/postgresql/config-keys\"\
  ,\n    \"description\": \"PostgreSQL features are configured through keys in your\
  \ databaseconfig... call. These keys live alongside the connection URL and model\
  \ paths.\",\n    \"image\": \"https://dbwarden.emiliano-go.com/assets/images/og-image.png\"\
  ,\n    \"publisher\": {\n      \"@type\": \"Organization\",\n      \"name\": \"\
