---
seo:
  title: Grants & Roles - DBWarden Documentation
  canonical: https://dbwarden.emiliano-go.com/databases/postgresql/grants-and-roles
  robots: index,follow
  og:
    type: website
    title: Grants & Roles - DBWarden Documentation
    description: Grants are handled by GrantsHandler DIFF phase. Roles are handled
      by RoleHandler PREAMBLE phase. Default privileges are handled by DefaultPrivilegesHandler...
    url: https://dbwarden.emiliano-go.com/databases/postgresql/grants-and-roles
  ...
  twitter:
    ...
    image:alt: DBWarden documentation
    site: '@emiliano_go_'
  description: Grants are handled by GrantsHandler DIFF phase. Roles are handled by
    RoleHandler PREAMBLE phase. Default privileges are handled by DefaultPrivilegesHandler...
  schema_jsonld:
  - '@context': https://schema.org
    '@type': WebPage
    name: Grants & Roles - DBWarden Documentation
    url: https://dbwarden.emiliano-go.com/databases/postgresql/grants-and-roles
    description: Grants are handled by GrantsHandler DIFF phase. Roles are handled
      by RoleHandler PREAMBLE phase. Default privileges are handled by DefaultPrivilegesHandler...
    image: https://dbwarden.emiliano-go.com/assets/images/og-image.png
  ...
  - '@context': https://schema.org
    ...
    - '@type': ListItem
      position: 3
      name: Grants And Roles
      item: https://dbwarden.emiliano-go.com/databases/postgresql/grants-and-roles
seo_html: "<title>Grants &amp; Roles - DBWarden Documentation</title>\n<meta name=\"\
  description\" content=\"Grants are handled by GrantsHandler DIFF phase. Roles are\
  \ handled by RoleHandler PREAMBLE phase. Default privileges are handled by DefaultPrivilegesHandler...\"\
  >\n<link rel=\"canonical\" href=\"https://dbwarden.emiliano-go.com/databases/postgresql/grants-and-roles\"\
  >\n<meta name=\"robots\" content=\"index,follow\">\n<meta property=\"og:type\" content=\"\
  website\">\n<meta property=\"og:title\" content=\"Grants &amp; Roles - DBWarden\
  \ Documentation\">\n<meta property=\"og:description\" content=\"Grants are handled\
  \ by GrantsHandler DIFF phase. Roles are handled by RoleHandler PREAMBLE phase.\
  \ Default privileges are handled by DefaultPrivilegesHandler...\">\n<meta property=\"\
  og:url\" content=\"https://dbwarden.emiliano-go.com/databases/postgresql/grants-and-roles\"\
  ...
  >\n<meta name=\"twitter:title\" content=\"Grants &amp; Roles - DBWarden Documentation\"\
  >\n<meta name=\"twitter:description\" content=\"Grants are handled by GrantsHandler\
  \ DIFF phase. Roles are handled by RoleHandler PREAMBLE phase. Default privileges\
  \ are handled by DefaultPrivilegesHandler...\">\n<meta name=\"twitter:image\" content=\"\
  ...
  ,\n    \"@type\": \"WebPage\",\n    \"name\": \"Grants & Roles - DBWarden Documentation\"\
  ,\n    \"url\": \"https://dbwarden.emiliano-go.com/databases/postgresql/grants-and-roles\"\
  ,\n    \"description\": \"Grants are handled by GrantsHandler DIFF phase. Roles\
  \ are handled by RoleHandler PREAMBLE phase. Default privileges are handled by DefaultPrivilegesHandler...\"\
  ,\n    \"image\": \"https://dbwarden.emiliano-go.com/assets/images/og-image.png\"\
  ,\n    \"publisher\": {\n      \"@type\": \"Organization\",\n      \"name\": \"\
