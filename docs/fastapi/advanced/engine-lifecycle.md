...
seo:
  ...
  canonical: https://emiliano-go.github.io/DBWarden/fastapi/advanced/engine-lifecycle/
  robots: index,follow
  og:
    type: website
    title: Engine Lifecycle - DBWarden Documentation
    description: Learn how DBWarden manages database engines and connections.
    url: https://emiliano-go.github.io/DBWarden/fastapi/advanced/engine-lifecycle/
