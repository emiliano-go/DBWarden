...
from strata.cli.validators import validate_strata_directory
from strata.commands import (
    handle_check_db,
    handle_diff,
    handle_env,
    handle_history,
...
app = typer.Typer(
    help="Strata - Professional-grade database migration system for Python models",
...
@app.command()
def init():
    """Initialize strata migrations directory."""
    handle_init()
...
@app.command()
def version():
    """Display Strata version and compatibility information."""
    handle_version()
...
def main() -> None:
    """Main entry point for Strata CLI."""
    app()
